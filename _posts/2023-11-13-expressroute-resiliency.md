---
layout: post
title:  "ExpressRoute resiliency"
author: davidsantiago
categories: [ azure, network, resiliency ]
image: assets/images/er-architecture.png
featured: true
---

# Understanding ExpressRoute private peering to address ExpressRoute resiliency

This article is co-authored by Microsoft colleague [Cynthia Treger](https://github.com/cynthiatreger). Original article is available [here](https://github.com/cynthiatreger/er-resiliency).
...
![]({{ site.baseurl }}/assets/images/er-architecture.png)
...
![]({{ site.baseurl }}/assets/images/cloud-exch-colo.png)
...
![]({{ site.baseurl }}/assets/images/eth-p2p.png)
...
![]({{ site.baseurl }}/assets/images/any2any.png)
...
![]({{ site.baseurl }}/assets/images/erd.png)
...
![]({{ site.baseurl }}/assets/images/er-circuit-resiliency.png)
...
![]({{ site.baseurl }}/assets/images/er-bowtie.png)
...
![]({{ site.baseurl }}/assets/images/er-circuit-skus.png)
...
![]({{ site.baseurl }}/assets/images/s2svpn-backup.png)
...
![]({{ site.baseurl }}/assets/images/active-active.png)
...
![]({{ site.baseurl }}/assets/images/az-redundant-ergw.png)
...
![]({{ site.baseurl }}/assets/images/route-advertisement-limits.png)
